...
public class BatterySubsystem extends SubsystemBase {
    ...
    private PowerDistribution powerDistribution = new PowerDistribution(Constants.canIdPowerDistributionUnit, ModuleType.kRev);
    ...
    public BatterySubsystem() {
        ...
        sbInputCurrent = btTab.add("Battery Input Current", 0)
                .withSize(2, 1)
    ...
    public double getVoltage() {
        return Robot.isSimulation() ? 14.2 : powerDistribution.getVoltage();
    }
    ...
    public void resetTimers() {
        // Note: Keeping timer values only works across redeploys, reboots always set
        // them to 0
