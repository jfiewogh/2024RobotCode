...
public class OI {
    ...
    public static final class Driver{
        ...
        // Shooter Buttons
        private static final Button kShooterButton = Button.RT;

        // Intake Buttons
        private static final Button kIntakeButton = Button.RB;
        private static final Button kOuttakeButton = Button.LB;
        private static final Button kIntakeDeployButton = Button.LT;
        private static final Button kIntakeAmpScoreButton = Button.B3; // B Button
        private static final Button kIntakeSourceButton = Button.B1; // X Button
        
        // Climb Buttons
        private static final Button kClimbToggleButton = Button.LJ;
        private static final Button kClimbRetractButton = Button.RJ;
        ...
        public static JoystickButton getIntakeDeployButton(){
            kIntakeDeployButton.setButtonAction("Deploy intake");
            return new JoystickButton(kJoystick, kIntakeDeployButton.getButtonID());
        }

        public static JoystickButton getAmpShootButton() {
            kIntakeAmpScoreButton.setButtonAction("Intake to amp position");
            return new JoystickButton(kJoystick, kIntakeAmpScoreButton.getButtonID());
        }
    
        public static JoystickButton getIntakeSourceButton(){
            kIntakeSourceButton.setButtonAction("Intake to source position");
            return new JoystickButton(kJoystick, kIntakeSourceButton.getButtonID());
        }

        public static JoystickButton getShooterButton(){
            kShooterButton.setButtonAction("Shoot");
            return new JoystickButton(kJoystick, kShooterButton.getButtonID());
        }
        
        public static JoystickButton getClimbToggleButton() {
            kClimbToggleButton.setButtonAction("Climb");
            return new JoystickButton(kJoystick, kClimbToggleButton.getButtonID());
        }

        public static JoystickButton getClimbRetractButton() {
            kClimbRetractButton.setButtonAction("Retract Climb");
            return new JoystickButton(kJoystick, kClimbRetractButton.getButtonID());
        }
    }
