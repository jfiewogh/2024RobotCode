...
public class Robot extends LoggedRobot {
  ...
  public static final String competitionRobotSerial = "00000000";
  public static final String practiceRobotSerial = "03064ec7";
  ...
  public void robotInit() {
    Logger.recordMetadata("FRC2158", "2024Robot"); // Set a metadata value

    if (isReal()) {
        if (Files.exists(Paths.get("/U/logs/"))) {
          Logger.addDataReceiver(new WPILOGWriter()); // Log to a USB stick ("/U/logs")      
        }
        Logger.addDataReceiver(new NT4Publisher()); // Publish data to NetworkTables
        
        try (PowerDistribution pd = new PowerDistribution(Constants.canIdPowerDistributionUnit, ModuleType.kRev)) {}; // Enables power distribution logging
